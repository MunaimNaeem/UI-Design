    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 160.0, middle: 0.5179),
            Pin(size: 27.0, start: 85.0),
            child: Text(
              'Esther Livingstone',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(size: 119.0, middle: 0.4395),
            Pin(size: 27.0, start: 120.0),
            child: Text(
              '08109502196',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(size: 168.0, middle: 0.3908),
            Pin(size: 30.0, end: 35.0),
            child: Text(
              'Become  A Driver',
              style: TextStyle(
                fontFamily: 'Segoe UI',
